...
var UserController = function () {
    var _classDecorators = [(0, common_1.Controller)(), (0, common_1.UsePipes)(validation_pipe_1.ValidationPipe)];
    ...
    var UserController = _classThis = /** @class */ (function () {
        ...
        UserController_1.prototype.createUser = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            throw new microservices_1.RpcException(error_1.message);
    ...
    (function () {
        ...
        _createUser_decorators = [(0, microservices_1.MessagePattern)({ cmd: 'sign_up' })];
